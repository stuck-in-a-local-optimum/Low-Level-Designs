...
import LLD.lldproblems.cricinfo.enums.WicketType;
...
import LLD.lldproblems.cricinfo.models.Wicket;
import LLD.lldproblems.cricinfo.observer.CommentaryDisplay;
import LLD.lldproblems.cricinfo.observer.ScorecardDisplay;
import LLD.lldproblems.cricinfo.observer.UserNotifier;
import LLD.lldproblems.cricinfo.strategy.T20FormatStrategy;
...
public class CricinfoDemo {
    public static void main(String[] args) {
        ...
        Player p4 = service.addPlayer("P4", "Jadeja", PlayerRole.BOWLER);
        ...
        Player p8 = service.addPlayer("P8", "Maxwell", PlayerRole.BATSMAN);
